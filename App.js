...
const forecast= []
 for (let i=1; i<6; i++){
   forecast.push(<forecastRow forecast={this.state.forecast[i]} key={i}></forecastRow>)
}
let forecast
  ...
  return (
    ...
    <Text style={styles.currentTemperature}>{this.state.currentTemperature.toString()}</Text>
    <Text style={styles.currentSummary}>{this.state.currentSummary.toString()}</Text>
    </View>
    <View style={styles.forecastDay} key={i}>
